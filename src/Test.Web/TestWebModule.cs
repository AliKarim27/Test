...
public class TestWebModule : AbpModule
{
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.Conventions.AuthorizePage("/Books/Index", TestPermissions.Books.Default);
            options.Conventions.AuthorizePage("/Books/CreateModal", TestPermissions.Books.Create);
            options.Conventions.AuthorizePage("/Books/EditModal", TestPermissions.Books.Edit);
        });
    }
    ...
    private void ConfigureVirtualFileSystem(IWebHostEnvironment hostingEnvironment)
    {
        ...
        {
            options.FileSets.AddEmbedded<TestWebModule>();
            ...
            if (hostingEnvironment.IsDevelopment())
            {
                ...
                options.FileSets.ReplaceEmbeddedByPhysical<TestApplicationModule>(Path.Combine(hostingEnvironment.ContentRootPath, string.Format("..{0}Test.Application", Path.DirectorySeparatorChar)));
